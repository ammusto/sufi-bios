...
const IsnadsListView = ({ data, filterPersonId, onViewChange }) => {
    ...
    const IsnadRow = ({ index, style, data }) => {  // data from itemData prop
        ...
        return (
            <div className="isnads-list-view">
                <div className="error-message">
                    ...
                    <p>Network data has not been loaded. Please ensure the data files are generated.</p>
                </div>
            </div>
        );
    }
